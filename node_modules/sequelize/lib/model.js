 ...
 * Accessing properties directly or using `get` is preferred for regular use, `getDataValue` shou'use strict';
...
class Model {
  ...
  /**
   * Validates this instance, and if the validation passe'use strict';
